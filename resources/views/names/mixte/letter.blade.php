    ...
    <div class="border-b border-violet-200">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 py-2">
        <ul class="text-xs">
          ...
          <li class="inline">Tous les prénoms mixtes commençant par la lettre {{ $activeLetter }}</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 py-2">
      <div class="grid name-index-grid gap-4">
        ...
        <div>
          ...
          <!-- names -->
          <h2 class="mb-2 font-bold text-xl text-center">Tous les prénoms mixtes commençant par la lettre {{ $activeLetter }}</h2>
